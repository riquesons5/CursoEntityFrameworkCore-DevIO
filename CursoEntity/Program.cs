...
using CursoEntity.ValueObjects;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Internal;

namespace CursoEntity
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /*
            Aplicar migração na hora de rodar a aplicação, não é recomendado utilizar em produção
            db.Database.Migrate();
             */
            ...
            //if (existe)
            //{
            //    //validando se existe migrações pendentes
            //}
        ...
        private static void AtualizarDados()
        {
            ...
            db.Attach(cliente); //rastrear o objeto
        ...
        private static void InserirDadosEmMassa()
        {
            ...
            var cliente = new Cliente
            {
                Nome = "Henrique Franco",
                CEP = "99999000",
                Cidade = "Criciúma",
                Estado = "SC",
                Telefone = "51999995500"
            };
